...
function ProductsInDb(){
    ...
    return(
        <div className="col-lg-6 mb-4 product-block">
            <div className="card shadow mb-4">
                ...
                <div className="card-body product-list">
                    ...
                    </p><a className="btn btn-danger" target="_blank" rel="nofollow" href="/">View movie detail</a>
                </div>
...
Drum & Bass Essentials is a production toolkit tailored for DnB or Liquid, Neurofunk and other subgenres. It features a set of three construction kits filled with 56 loops, 26 Massive presets, 16 MIDI loops, 13 kicks, 13 snares, 9 top loops.
                ...
                <div className="card-body product-list">
                    ...
                    <p>
                        This Unique collection will find its place in your library as an indispensable reference point for your next movie, trailer, game, documentary, advertising or any kind of cinematic and multimedia project.
                    </p>    
                    <a className="btn btn-danger" target="_blank" rel="nofollow" href="/">View movie detail</a>
                </div>   
            </div>
